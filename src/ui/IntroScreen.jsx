...
const HOLD_START  = 100    // ms — how long before text starts appearing
const TEXT_IN     = 200   // ms — fade+blur in duration
const HOLD_TEXT   = 300    // ms — hold at full opacity
const BTN_DELAY   = HOLD_START + TEXT_IN + HOLD_TEXT  // when button appears
const EXIT_DUR    = 300    // ms — exit animation duration
