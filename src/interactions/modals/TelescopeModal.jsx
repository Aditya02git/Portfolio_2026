...
export default function TelescopeModal({ onClose }) {
  return (
    <ModalWrapper icon="🔭" title="Future Under Construction!" onClose={onClose}>
      <style>{`
      ...
      `}</style>
        ...
        }}>This telescope isn’t for stars —it’s for possibilities.</div>
    </ModalWrapper>
  )
}